...
let arr_colors = [
	...
	['#b9b4af','#5b5a57','#444241','#181717','#3c3c3a','#76726e','#878480','#f1f0eb','#4c4c44','#7e7c73'],
	...
	['#8841c0','#7d2960','#2e0f7d','#1d0f3a','#542052','#403252','#604c7b','#3c153d'],
	...
	['#131212','#333530','#81b46e','#3a3e37','#fef1af','#e0b154','#a77740','#36342e','#384334'], // w,org,yellow,brown,black,green
	['#f6eccc','#e4d3a8','#6c6351','#554b3e','#3c372f'], // 233 --> brown
	['#212c33','#e36341','#fef7d4','#a39676','#fbeec2','#67645f','#533433','#353333',], // org,black,233,brown,red
	['#d3cfcb','#3e372c','#9a8f80','#c89843','#7e7b7a','#73634d','#acaca3','#5f5e5c','#acacac','#827c6a'],
	['#463c39','#b6b2b1','#7e7977','#949490','#21201f'], // 20
	['#654d49','#d5ccc3','#9f948c','#c29487','#9c635b','#292423','#b8acac','#601616','#837c7c','#d1b49c'],
	['#181717','#5b5a57','#444241'],//'#5b5a57','#444241','#181717','#3c3c3a','#76726e','#878480','#f1f0eb','#4c4c44','#7e7c73'],



	['#dca040','#dc5434','#e4dc9c','#f2f1e7','#545434','#42342f','#2c4444','#d0b4a4','#c89080','#8c8c74'],// autumn 
	['#ffffff'],
	['#125b32','#447551'],
	['#284a4c','#6e5b4d','#8f7e66','#7c8d84','#1bc1ba','#bcbe96','#b0c1b8','#d0c7b8'],
	['#dddddd','#dd2222','#663322',],
	['#d0abb8','#2a191e','#885560','#5e3340','#9c9c91','#be3264','#695a66','#645f55','#493d46','#9e829d'], // 9 == pink forst
	['#dfd8cf','#1c1c1c'], // 10 brwdn wihte
  ['#dfd8cf','#1c1c1c','#004444'] ,
  ['#4a667e','#c0bfbb','#4d3714','#a2a2a0','#8a693a','#333940','#6e7577','#191c19'],
  ['#1e81b0','#eeeee4','#e28743','#eab676','#76b5c5','#21130d','#873e23','#abdbe3','#063970','#ff1111'],
  ['#000000'],
  ['#fee40b','#ef7400','#ca2b27','#0088c4','#3ec46d'], // coral
  ['#42e8dc','#23648f','#42e8dc','#23648f','#1d3241','#968f73','#f1f2ef','#e37847'],
  ['#848283','#57b8bc','#259faf','#152636','#044553'], // 36 //'#b4d2d3'
  ['#770000'], // 37
  ['#77110d','#ad5316',
'#2b482c','#caa330','#2b4025','#192718',
'#c09c31','#f29f31',
'#be681d','#ae341d',
'#0b0c0c','#291815'], // 38
...
, ['#8C2C6B', '#6C0D21', '#44060E', '#3361F4', '#3E1E1E', '#894586', '#8C9703', '#0DD601', '#365838', '#9CD405', '#F5C8BB', '#AC3628']
...
,['#2D74A4', '#D2D2F2', '#1F3767', '#C60042', '#7F2AD9', '#664564', '#FF8E8C', '#4E5644', '#AA88F7']
...
['#2a3c2c','#364c37',// grn gren
'#858e80','#757c6f', // gry gry
'#24281b','#684432', // blk brn
'#262628','#000000', //blk blk
'#405831','#405441'], // wt wt
...
['#dad7cd', '#a3b18a', '#588157', '#3a5a40', '#344e41'],// 90
 ...
 ['#848283', '#219ebc', '#023047','#023047', '#ffb703', '#fb8500','#ffb703', '#fb8500'], // 92
...
['#ef476f', '#ffd166', '#06d6a0', '#118ab2', '#073b4c'],
 ['#fbf8cc', '#fde4cf', '#ffcfd2', '#f1c0e8', '#cfbaf0', '#a3c4f3', '#90dbf4', '#8eecf5', '#98f5e1', '#b9fbc0'], //100
...
['#002222','#003333','#004444','#005555','#006666','#007777','#008888','#009999'], // blue plt //132

['#2b3d3d','#c6c5b9','#835d5e','#90ae9f','#8b2c33','#7c2c35','#3e3134','#5d4b4d','#3e3e41'], //133 // milli
['#201329','#121719','#40305d','#33777c','#1c3a44','#6c939c'], // night
['#1a1a1a','#2a2728','#f9f2e6','#c6b8a4','#a19a77','#575544','#36342d'],// vin drk
['#d8ac66','#cfaf85','#b1ab8d','#493f33','#695e43','#393933','#c39b6e','#2c1c1a','#462521'], // vin
...
function func_kind(k,temp,map_grps){
  // console.log('k==',k)
  // throw "s"
 return k == 0 ? temp <= map_grps.size/2 : // half
  k == 1 ? temp%2==0 : // %
  k == 2 ? true : // only noise
...
0x110000, // grd //  '#162232'
[
  arr_colors[7],arr_colors[11] // arr_colors[78]
], // tres
11, // trials c
true, /// grp t c
7, // t p
